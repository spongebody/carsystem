  ...
  <div class="com-page">
      ...
      <div class="com-pannel-wrp">
        <div class="com-pannel">
          <el-row class="search-row">
            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="5">
              <el-form-item label="所属部门：" label-width="91px">
                <el-input
                  placeholder="请输入所属部门"
                  v-model="basicInfoQuery.column.dept"
                  clearable
                  @keydown.enter.native="searchResult"
                ></el-input>
              </el-form-item>
    ...
    >
      ...
      >
        <div class="com-pannel">
          <el-col :span="24">
            <el-form-item label-width="110px" label="姓名：" prop="driver">
              <el-input
                v-model="userInfoDialog.model.name"
        ...
        <div class="com-pannel">
          <el-col :span="24">
            <el-form-item label-width="110px" label="部门：">
              <el-input
                v-model="userInfoDialog.model.dept "
                :disabled="!userInfoDialog.isMod && !userInfoDialog.isCreate"
              >
              </el-input>
            </el-form-item>
