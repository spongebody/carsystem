      ...
      <div class="com-pannel-wrp">
        <div class="com-pannel">
          <el-row class="search-row">
            <el-col :xs="24" :sm="12" :md="8" :lg="5">
              ...
              >
                <el-input
                  ...
                  v-model="basicInfoQuery.column.rider"
                  clearable
            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="5">
              <el-form-item label="司机电话：" label-width="91px">
                <el-input
                  placeholder="请输入司机电话"
                  v-model="basicInfoQuery.column.driverTel"
                  clearable
                  @keydown.enter.native="searchResult"
                ></el-input>
              </el-form-item>
        ...
        <div class="com-pannel">
          <el-row class="search-row">
            <el-col :xs="24" :sm="12" :md="8" :lg="5">
              ...
              >
                <el-date-picker
                  v-model="basicInfoQuery.column.time"
                  type="daterange"
                  range-separator="-"
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  size="small"
                >
                  <span v-if="scope.row.review" class="review-done">已审核</span>
                  <span v-else @click="review(scope.row)">待审</span>
                </el-button>
              </template>
            </el-table-column>
          </el-table>
